...
// const response = fetch(BASE_API_URL+"/login", {method: 'POST', body: 'email=adrian@adriannadeau.com'});
// const data = response.json();
    

    // const response = await fetch(BASE_API_URL+"/login", {method: 'POST', body: 'email=adrian@adriannadeau.com'});
    ...
    //     res.render('auth-email-verification-2', { layout: "layout/layout-without-nav", });
    // });
    // //email
    ...
    //     res.render('auth-lock-screen-2', { layout: "layout/layout-without-nav", });
    // });
    // //lock screen
    ...
    //     res.render('auth-login-2', { layout: "layout/layout-without-nav", });
    // });
    ...
    //     res.render('auth-recoverpw-2', { layout: "layout/layout-without-nav", });
    // });
    ...
    //     res.render('auth-register-2', { layout: "layout/layout-without-nav", });
    // });
    ...
    //     res.render('auth-two-step-verification-2', { layout: "layout/layout-without-nav", });
    // });
    ...
    //     res.render('crypto-ico-landing', { layout: 'layout/layout-without-nav' });
    // });
    ...
    //     res.render('layouts-hori-boxed-width', { layout: "layout/layouts-hori-boxed-width", title: "Horizontal Layout", page_title: 'Horizontal Layout' });
    // });
    // route.get('/layouts-hori-colored-header', function (req, res) {
    //     res.render('layouts-hori-colored-header', { layout: "layout/layouts-hori-colored-header", title: "Icon Sidebar", page_title: 'Icon Sidebar' });
    // });
    // route.get('/layouts-hori-preloader', function (req, res) {
    //     res.render('layouts-hori-preloader', { layout: "layout/layouts-hori-preloader", title: "Light Sidebar", page_title: 'Light Sidebar' });
    // });
    // route.get('/layouts-hori-scrollable', function (req, res) {
    //     res.render('layouts-hori-scrollable', { layout: "layout/layouts-hori-scrollable", title: "Light Sidebar", page_title: 'Light Sidebar' });
    // });
    // route.get('/layouts-hori-topbar-light', function (req, res) {
    //     res.render('layouts-hori-topbar-light', { layout: "layout/layouts-hori-topbar-light", title: "Light Sidebar", page_title: 'Light Sidebar' });
    // });
    ...
    //     res.render('layouts-preloader', { layout: "layout/layouts-preloader", title: "Light Sidebar", page_title: 'Light Sidebar' });
    // });
    // route.get('/layouts-scrollable', function (req, res) {
    //     res.render('layouts-scrollable', { layout: "layout/layouts-scrollable", title: "Light Sidebar", page_title: 'Light Sidebar' });
    // });
